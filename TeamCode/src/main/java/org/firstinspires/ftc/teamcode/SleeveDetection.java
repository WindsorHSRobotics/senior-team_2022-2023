...
// Not an opmode. Detects the color of the sleeve to determine parking pos.
public class SleeveDetection extends OpenCvPipeline {
    ...
    private static final Scalar
            lower_yellow_bounds  = new Scalar(80, 80, 0, 255),
            upper_yellow_bounds  = new Scalar(255, 255, 130, 255),
            lower_cyan_bounds    = new Scalar(0, 90, 90, 255),
            upper_cyan_bounds    = new Scalar(150, 255, 255, 255),
            lower_magenta_bounds = new Scalar(80, 0, 80, 255),
